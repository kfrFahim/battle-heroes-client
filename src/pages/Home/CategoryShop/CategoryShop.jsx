    ...
    <div className="max-w-[1200px] mx-auto my-5 p-4">
      ...
      <Tabs>
        <TabList className="text-center">
          <Tab>
            <p className="md:text-xl font-bold">Marvel</p>
          </Tab>
          <Tab>
            <p className="md:text-xl font-bold">Star Wars</p>
          </Tab>
          <Tab>
            <p className="md:text-xl font-bold">Transformer</p>
          </Tab>
          <Tab>
            <p className="md:text-xl font-bold">Avengers</p>
          </Tab>
          <hr />
        </TabList>
            ...
            {allToys.slice(0, 3).map((alltoy) => (
              <div className="">
                <div className="card card-compact w-64 h-full bg-base-100 shadow-xl mx-auto ">
                  <figure>
                    <img src={alltoy.image} alt="Shoes" />
                  </figure>
